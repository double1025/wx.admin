	...
	<el-container>
		<el-main class='x-main-edit'>
			<el-form ref="form" :rules="form_rules" :model="form" size="mini" label-width="15%">
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						<el-form-item label="日期" prop="time_end" ref="end_date">
							<el-time-select
								placeholder="起始时间"
			...
			<div class="save_wrap">
				...
				<el-button type="success" @click="g_page.funcSave" size="mini">批量生成时间点</el-button>
...
<script>
	...
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/app_share_tea/app_share_tea__time__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/app_share_tea/app_share_tea__time__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

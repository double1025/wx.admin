<template>
	<el-container>
		<el-header class='x-header'>
			...
			<el-button size="mini" type="success" icon="el-icon-edit" @click="g_page.funcRedirectEdit(`app_share_tea__time__edit`)">
				添加
			</el-button>
		...
		<el-main class='x-main'>
			<el-form :inline="true" :model="form_q" size="mini">
				<el-form-item label="时间点">
					<el-input name="compKw" v-model="form_q.compKw" placeholder="时间点"></el-input>
				</el-form-item>
				<el-form-item>
...
<script>
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/app_share_tea/app_share_tea__time__list')
			this.g_page.funcSetApiUrlDel('/xadmin/app_share_tea/app_share_tea__time__list/del')
			//页码

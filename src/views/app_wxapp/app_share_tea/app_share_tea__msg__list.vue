<template>
	<el-container>
		<el-header class='x-header'>
			...
			<el-button size="mini" type="success" icon="el-icon-edit" @click="g_page.funcRedirectEdit(`app_share_tea__msg__edit`)">
				添加
			</el-button>
		...
		<el-main class='x-main'>
			<el-form :inline="true" :model="form_q" size="mini">
				<el-form-item label="名称">
					<el-input name="compKw" v-model="form_q.compKw" placeholder="内容"></el-input>
				</el-form-item>
				<el-form-item>
				...
				<el-table stripe ref="multipleTable" tooltip-effect="dark"
					...
					<el-table-column label="编号">
						<template slot-scope="data">
							<div v-html="data.row.log_id"></div>
						</template>
					</el-table-column>
					...
					<el-table-column label="标题">
						<template slot-scope="data">
							<div v-html="data.row.log_str_00"></div>
						</template>
					</el-table-column>
					<el-table-column label="通知内容">
						<template slot-scope="data">
							<el-input type="textarea" v-model="data.row.log_txt_00"></el-input>
						</template>
					</el-table-column>
					...
					<el-table-column fixed="right" label="操作">
						<template slot-scope="data">
							<el-button type="primary" size="mini" @click="g_page.funcRedirectEdit('app_share_tea__msg__edit',data.row)">
								编辑
							</el-button>
						</template>
					</el-table-column>
...
<script>
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/app_share_tea/app_share_tea__msg__list')
			this.g_page.funcSetApiUrlDel('/xadmin/app_share_tea/app_share_tea__msg__list/del')
			//页码

			...
			<div class="table-wrap">
				<el-table stripe ref="multipleTable" tooltip-effect="dark"
					...
					<el-table-column label="优惠券" width="300">
						<template slot-scope="data">
							<div v-for="(val,key) in data.row.txt_00">
								{{ key }}：{{ val }}
							</div>
						</template>
					</el-table-column>
					<el-table-column label="状态">
						<template slot-scope="data">
							<div v-if="data.row.log_int_00==1">已读</div>
...
<script>
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/app_share_tea/app_share_tea__msg__act__list')
			this.g_page.funcSetApiUrlDel('/xadmin/app_share_tea/app_share_tea__msg__act__list/del')
			//页码

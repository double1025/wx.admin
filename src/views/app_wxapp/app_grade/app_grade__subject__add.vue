				...
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						<el-form-item label="说明">
							<a target="_blank" :href="`${page_info.static_file_root}view/app/app_grade/xls/题目导入模板.xlsx`">模板下载</a>
							<div class="x-alert">
								<span>模板选择项格式说明<br>多个选择项以<b style="color:red;">#号</b>号隔开，选择内容与评分以<b style="color:red;">|号</b>隔开</span>
							</div>
						</el-form-item>
						<ImportExcelComponent
							:upload_step="10" :api_url="api_url"
...
<script>
	...
	export default {
		...
		data() {
			let page_data = {
				api_url: '/xadmin/app_grade/app_grade__subject__add/import'
			}
			//
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/app_grade/app_grade__subject__add')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

			...
			<el-form ref="form" :rules="form_rules" :model="form" size="mini" label-width="15%">
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						<el-form-item label="企业代码" prop="abc_str_00">
							<el-input class="x-input-60" v-model="form.abc_str_00"></el-input>
						</el-form-item>
						<el-form-item label="企业名称" prop="abc_name">
...
<script>
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/app_grade/app_grade__code__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/app_grade/app_grade__code__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

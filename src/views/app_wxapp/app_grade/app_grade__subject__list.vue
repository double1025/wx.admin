<template>
	<el-container>
		<el-header class='x-header'>
			...
			<el-button size="mini" type="primary" icon="el-icon-edit" @click="g_page.funcRedirectEdit(`app_grade__subject__add`)">
				批量导入题目
			</el-button>
			<el-button size="mini" type="success" icon="el-icon-edit" @click="g_page.funcRedirectEdit(`app_grade__subject__edit?pid=${form_q.pid}`)">
				添加
			</el-button>
			...
			<div class="table-wrap">
				<el-table stripe ref="multipleTable" tooltip-effect="dark"
					...
					<el-table-column fixed="right" label="操作">
						<template slot-scope="data">
							<el-button type="primary" size="mini" @click="g_page.funcRedirectEdit('app_grade__subject__edit',data.row)">
								编辑
							</el-button>
						</template>
					</el-table-column>
...
<script>
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/app_grade/app_grade__subject__list')
			this.g_page.funcSetApiUrlDel('/xadmin/app_grade/app_grade__subject__list/del')
			//页码

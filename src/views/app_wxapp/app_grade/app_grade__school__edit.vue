...
<!--						</el-form-item>-->
						<el-form-item label="学校名称" prop="abc_str_03">
...
<script>
	...
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/app_grade/app_grade__school__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/app_grade/app_grade__school__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

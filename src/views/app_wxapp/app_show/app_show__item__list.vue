<template>
	<el-container>
		<el-header class='x-header'>
			...
			<el-button size="mini" type="success" icon="el-icon-edit" @click="g_page.funcRedirectEdit(`app_show__item__edit`)">
				添加
			</el-button>
			...
			<div class="table-wrap">
				<el-table stripe ref="multipleTable" tooltip-effect="dark"
					...
					<el-table-column label="展示图">
						<template slot-scope="data">
							<CompImg :img_root="page_info.static_file_root" :img_val="data.row.abc_str_00"></CompImg>
						</template>
					</el-table-column>
					<el-table-column label="上线时间">
						<template slot-scope="data">
							<div v-html="data.row.abc_date_00"></div>
						</template>
					</el-table-column>
					<el-table-column label="小程序参数">
						<template slot-scope="data">
							<div v-html="data.row.abc_str_01"></div>
							<div v-html="data.row.abc_str_02"></div>
						</template>
					</el-table-column>
					...
					<el-table-column fixed="right" label="操作">
						<template slot-scope="data">
							<el-button type="primary" size="mini" @click="g_page.funcRedirectEdit('app_show__item__edit',data.row)">
								编辑
							</el-button>
						</template>
					</el-table-column>
...
<script>
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/app_show/app_show__item__list')
			this.g_page.funcSetApiUrlDel('/xadmin/app_show/app_show__item__list/del')
			//页码

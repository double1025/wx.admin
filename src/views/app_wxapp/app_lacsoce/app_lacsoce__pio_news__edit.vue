			...
			<el-form ref="form" :rules="form_rules" :model="form" size="mini" label-width="15%">
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						...
						<el-form-item label="副标题" prop="abc_str_03">
							<el-input class="x-input-60" v-model="form.abc_str_03"></el-input>
						</el-form-item>
...
<script>
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/app_lacsoce/app_lacsoce__pio_news__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/app_lacsoce/app_lacsoce__pio_news__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

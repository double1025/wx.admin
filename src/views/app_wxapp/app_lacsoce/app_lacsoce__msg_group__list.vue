<template>
	<el-container>
		<el-header class='x-header'>
			...
			<el-button size="mini" type="success" icon="el-icon-edit" @click="g_page.funcRedirectEdit('app_lacsoce__msg_group__edit')">
				添加
			</el-button>
			...
			<div class="table-wrap">
				<el-table stripe ref="multipleTable" tooltip-effect="dark"
					...
					<el-table-column label="描述">
						<template slot-scope="data">
							<el-input type="textarea" v-model="data.row.abc_txt_00"></el-input>
						</template>
					</el-table-column>
					...
					<el-table-column fixed="right" label="操作">
						<template slot-scope="data">
							<el-button type="primary" size="mini" @click="g_page.funcRedirectEdit('app_lacsoce__msg_group__edit',data.row)">
								编辑
							</el-button>
							<el-button type="primary" size="mini" @click="g_page.funcRedirectEdit(`app_lacsoce__msg__list?pid=${data.row.id}`)">
								资料列表
							</el-button>
						</template>
					</el-table-column>
...
<script>
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/app_lacsoce/app_lacsoce__msg_group__list')
			this.g_page.funcSetApiUrlDel('/xadmin/app_lacsoce/app_lacsoce__msg_group__list/del')
			//页码

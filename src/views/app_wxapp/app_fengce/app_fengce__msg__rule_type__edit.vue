...
<script>
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/app_fengce/app_fengce__msg__rule_type__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/app_fengce/app_fengce__msg__rule_type__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

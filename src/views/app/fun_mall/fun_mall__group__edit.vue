			...
			<el-form ref="form" :rules="form_rules" :model="form" size="mini" label-width="15%">
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						...
						<el-form-item label="图标" prop="abc_str_00">
...
<script>
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/fun_mall/fun_mall__group__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/fun_mall/fun_mall__group__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

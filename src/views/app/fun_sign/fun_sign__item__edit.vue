				...
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						<el-form-item label="名称" prop="abc_name">
							<el-input v-model="form.abc_name" class="x-input-60"></el-input>
						</el-form-item>
						<el-form-item label="有效期" prop="abc_date_01">
							<el-date-picker
								style="width: 200px;"
							...
							<el-date-picker
								style="width: 200px;"
								v-model="form.abc_date_01"
								type="date"
								placeholder="选择结束时间"
								value-format="yyyy-MM-dd">
							</el-date-picker>
						</el-form-item>
						<el-form-item label="配置积分" prop="abc_int_00">
							初始值
							<el-input-number :min="1" v-model="form.abc_int_00" :step="1"></el-input-number>
							&nbsp;
							每次递增值
							<el-input-number :min="1" v-model="form.abc_int_02" :step="1"></el-input-number>
							&nbsp;
							最大值
							<el-input-number :min="1" v-model="form.abc_int_01" :step="1"></el-input-number>
						</el-form-item>
...
<script>
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/fun_sign/fun_sign__item__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/fun_sign/fun_sign__item__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

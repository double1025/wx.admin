<template>
	<el-container>
		<el-header class='x-header'>
			...
			<el-button size="mini" type="primary" icon="el-icon-download" @click="g_page.funcExport('/cashbook/admin/cashbook/export')">
				导出
			</el-button>
...
<script>
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/cashbook/cashbook__list')
			this.g_page.funcSetApiUrlDel('/xadmin/cashbook/cashbook__list/del')
			//页码

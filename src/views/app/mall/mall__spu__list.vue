<template>
	<el-container>
		<el-header class='x-header'>
			...
			<el-button size="mini" type="success" icon="el-icon-edit" @click="funcAdd">添加</el-button>
				...
				<el-table stripe ref="multipleTable" tooltip-effect="dark"
					...
					<el-table-column fixed="right" label="操作">
						<template slot-scope="data">
							...
							<el-button size="mini" @click="funcRecord(data.row)">填写记录</el-button>
						</template>
					</el-table-column>
				</el-table>
				<a target="_blank"></a>
	...
	export default {
		...
		methods: {
			funcEdit(row) {
				...
				this.g_cc.func_redirect('/sheet/sheet__sheet__edit', {
					id: id,
					callback_url: '/sheet/sheet__sheet__list'
				})
			},
			//
			funcRecord(row) {
				...
				this.g_cc.func_redirect('/sheet/sheet__record__list', {
					pid: id,
					callback_url: '/sheet/sheet__sheet__list'
				})
			},

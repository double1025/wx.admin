			...
			<el-form ref="form" :rules="form_rules" :model="form" size="mini" label-width="15%">
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						<el-form-item label="活动名称" prop="abc_name">
							<el-input class="x-input-60" v-model="form.abc_name"></el-input>
						</el-form-item>
						<el-form-item label="活动图" prop="abc_str_02">
						...
						<el-form-item label="活动时间" prop="abc_str_00">
							<el-input class="x-input-60" v-model="form.abc_str_00"></el-input>
						</el-form-item>
						<el-form-item label="活动内容" prop="abc_long_00">
...
<script>
	...
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/place/place__act__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/place/place__act__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

<template>
	<el-container>
		<el-header class='x-header'>
			...
			<el-button size="mini" type="success" icon="el-icon-edit" @click="g_page.funcRedirectEdit(`place__act__edit`)">
				添加
			</el-button>
		...
		<el-main class='x-main'>
			<el-form :inline="true" :model="form_q" size="mini">
				...
				<br/>
				<el-form-item>
					<el-button type="text" size="mini" @click="g_page.funcRedirectEdit(`place__act__data__list`)">
						前往报名列表
					</el-button>
				</el-form-item>
			</el-form>
			<div class="table-wrap">
				<el-table stripe ref="multipleTable" tooltip-effect="dark"
					...
					<el-table-column label="隐藏">
						<template slot-scope="data">
							<div style="color:red;" v-if="data.row.abc_hide==1">是</div>
						</template>
					</el-table-column>
					...
					<el-table-column fixed="right" label="操作">
						<template slot-scope="data">
							<el-button type="text" size="mini" @click="g_page.funcRedirectEdit(`place__act__edit`,data.row)">
								编辑
							</el-button>
						</template>
					</el-table-column>
...
<script>
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/place/place__act__list')
			this.g_page.funcSetApiUrlDel('/xadmin/place/place__act__list/del')
			//页码

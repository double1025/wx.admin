<template>
	<el-container>
		<el-header class='x-header'>
			...
			<ExprotExcel api_url="/xadmin/place/place__act__data__list/export" :api_data="form_q"></ExprotExcel>
			...
			<div class="table-wrap">
				<el-table stripe ref="multipleTable" tooltip-effect="dark"
					...
					<el-table-column label="手机">
						<template slot-scope="data">
							<div v-html="data.row.log_str_01"></div>
						</template>
					</el-table-column>
					<el-table-column label="报名时间">
						<template slot-scope="data">
							<div v-html="data.row.log_create_date"></div>
						</template>
					</el-table-column>
...
<script>
	...
	export default {
		...
		mounted() {
			...
			// 应用ID
			this.g_page.funcSetApiUrlList('/xadmin/place/place__act__data__list')
			this.g_page.funcSetApiUrlDel('/xadmin/place/place__act__data__list/del')
			//页码

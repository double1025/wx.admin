			...
			<el-form ref="form" :rules="form_rules" :model="form" size="mini" label-width="15%">
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						...
						<el-form-item label="封面图" prop="abc_str_00">
						...
						<el-form-item label="详情" prop="abc_long_00">
...
<script>
	...
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/place/place__route__edit')
			this.g_page.funcSetApiUrlSave('/xadmin/place/place__route__edit/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{

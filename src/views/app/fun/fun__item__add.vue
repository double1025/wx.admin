	...
	<el-container>
		<el-main class='x-main-edit'>
			<el-form ref="form" :rules="form_rules" :model="form" size="mini" label-width="15%">
				<el-tabs type="border-card" v-model="page_tag">
					...
					<el-tab-pane :label="page_info.title" name="1">
						<el-form-item label="内容" prop="txt" ref="txt">
							<el-input class="x-input-60" type="textarea" rows="10" v-model="form.txt" placeholder="用户,积分,描述(可空)"/>
						</el-form-item>
					</el-tab-pane>
					<!---->
					<!---->
			...
			<div class="save_wrap">
				...
				<el-button type="success" @click="g_page.funcSave" size="mini">积分操作</el-button>
...
<script>
	export default {
		...
		mounted() {
			...
			//
			this.g_page.funcSetApiUrlEdit('/xadmin/fun/fun__item__add')
			this.g_page.funcSetApiUrlSave('/xadmin/fun/fun__item__add/save')
			let page = this
			//验证
			this.form_rules = {
				__test: [{
